...
if (isset($_POST['submit'])) {
      ...
      if (mysqli_num_rows($user_check_result) > 0) {
        ...
        if (in_array($extention, $allowed_files)) {
          ...
          if ($avatar['size'] < 1000000) {
            ...
            $_SESSION['add-user'] = 'The image should be equal or less than 1mb';
          }
        } else {
          $_SESSION['add-user'] = 'The image should be in jpg, jpeg or png format';
        }
      }
    }
  }

  // redirect to add-user page if there is any problem
  ...
  // if button was clicked bounce back to add-user page
  header('location: ' . ROOT_URL . 'admin/add-user.php');
  die();
}
